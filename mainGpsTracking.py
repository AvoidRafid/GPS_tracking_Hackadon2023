...
medium_traffic = [[[48.7522463878005, 11.432074998961319],
                   [48.75133035632122, 11.432488287532463],  # stop
                   [48.751046267173805, 11.43258501467965],
                   [48.75052307393989, 11.432817976616379] ], [[48.75936791243698, 11.43082035370531],
                                                                [48.759151355857966, 11.431051193026699],
                                                                [48.758331944136344, 11.431202126429147],
                                                                [48.75691904779684, 11.430914273739942] ],
                  [[48.73873650860007, 11.436916392030053],
...
stations = [[48.75428710664237, 11.43116048819216],[48.74688693742944, 11.434716980612615]]
...
for i, station_location in enumerate(stations):
    # Slightly modify the latitude or longitude of the station markers
    modified_location = [coord + i * 0.03 for coord in station_location]
    station_location_markers.append(
        folium.Marker(location=modified_location, popup="Station", icon=station_icon).add_to(ingolstadt_map)
    )
...
for coords in route_coordinates:
    ...
    # Setting the location of each station marker after each movement
    for i, _ in enumerate(stations):
        modified_location = [coord + i * 0.03 for coord in stations[i]]
        station_location_markers[i].location = modified_location
